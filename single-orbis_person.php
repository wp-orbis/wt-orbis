		...
		<div class="col-md-4">
			<?php if ( get_option( 'orbis_twitter_widget_id' ) && get_post_meta( $post->ID, '_orbis_person_twitter', true ) ) : ?>
				...
				<div class="panel">
					...
					<div class="content">
						<p class="alt">
							<a class="twitter-timeline" href="<?php echo esc_attr( $twitter_username ); ?>" data-widget-id="<?php echo esc_attr( $twitter_widget_id ); ?>" data-screen-name="<?php echo $username; ?>" height="300"><?php echo esc_html( $twitter_text ); ?></a>
